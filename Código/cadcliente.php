          ...
          <div class="card-body">
            ...
            <form class="row g-3" method="post">
              ...
              <div class="col-md-6" id="div-rs" style="display: none;">
                ...
                <input type="text" class="form-control" id="rs" name="rs" tabindex="1" maxlength="45" >
              </div>
              <div class="col-md-6" id="div-nf" style="display: none;">
                <label for="nf" class="form-label">Nome Fantasia:</label>
                <input type="text" class="form-control" id="nf" name="nf" tabindex="2" maxlength="45" >
              </div>
              <div class="col-md-6" id="div-nm" >
                <label for="nm" class="form-label">Nome Completo:</label>
                <input type="text" class="form-control" id="nm" name="nm" tabindex="1" maxlength="45" required>
              </div>
              <div class="col-md-6" id="div-nc" >
                <label for="nc" class="form-label" >Nome Comercial: </label>
                <input type="text" class="form-control" id="nc" name="nc" tabindex="2" maxlength="45" required>
              </div>

              <div class="col-md-6">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control" id="email" name="email" tabindex="3">
              </div>
              <div class="col-md-6">
                <label for="nrfone" class="form-label">Telefone:</label>
                <input type="tel" class="form-control telefone" id="nrfone" name="nrfone" tabindex="4" placeholder="(00) 00000-0000">
              </div>
              <hr>
              ...
              <div class="row">
                ...
                <div class="col-md-4  ">
                  ...
                  <select name="idlinhavenda" class="form-select" tabindex="10" aria-label="Seleção linha de venda" required>
                    <option selected disabled>Linha de Venda</option>
                    <?php
                    
                    foreach ($cliente->listar_linha() as $key) {
              ...
              <input type="hidden" name="ifornecedor" value="0">
            ...
            if (isset($_POST['cadastrar'])) {
              ...
              $cnpj_cpf = ($ipessoafisica == 1) ? $_POST['cpf'] : $_POST['cnpj'];
              $ie = $_POST['ie'];
              $cep = $_POST['cep'];
              $cidade = $_POST['cidade'];
              $idlinhavenda = (isset($_POST['idlinhavenda']))? $_POST['idlinhavenda'] : -1;
              $bairro = $_POST['bairro'];
              $rua = $_POST['rua'];
              $nrlocal = $_POST['nrlocal'];
              $ifornecedor = $_POST['ifornecedor'];
              $cliente->inserir($rs_nm, $nf_nc, $email, $nrfone, $ipessoafisica, $cnpj_cpf, $ie, $cep, $cidade, $idlinhavenda, $bairro, $rua, $nrlocal, $ifornecedor);
            }
